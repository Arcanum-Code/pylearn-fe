...
export { UserDistribution } from "./components/UserDistribution";
...
export { LecturerDashboardContainer } from "./components/LecturerDashboardContainer";
...
export * from "./hooks/useLecturerDashboard";
export * from "./types";
